...
.mv-entity h3,.mv-entity p,.mv-fact strong,.mv-fact span,.mv-matrix th,.mv-matrix td{overflow-wrap:break-word;word-break:normal;line-break:auto}.mv-entity h3,.mv-fact strong{overflow-wrap:anywhere}
.mv-flow-sequence{position:relative;z-index:1;display:flex;align-items:stretch;gap:7px;width:100%;min-width:0;padding:4px;overflow-x:auto}.mv-flow-step{display:grid;align-content:start;gap:5px;min-width:150px;flex:1 0 150px}.mv-flow-step>.mv-entity{height:100%}
...
.mv-flow-branches{position:relative;z-index:1;display:grid;gap:7px;margin-top:8px}.mv-flow-branch{display:grid;grid-template-columns:minmax(92px,auto) 72px minmax(150px,1fr);gap:7px;align-items:stretch}.mv-flow-branch-ref{display:grid;place-items:center;min-width:92px;padding:7px 9px;border:1px dashed var(--border);border-radius:999px;background:var(--surface-2);color:var(--muted);font:650 9px/1.2 var(--mono);text-align:center}.mv-flow-branch--unlinked{grid-template-columns:minmax(92px,auto) minmax(150px,1fr)}
.mv-flow-secondary-relations{position:relative;z-index:1;display:grid;gap:8px;margin:11px 0 0;padding:0;list-style:none}.mv-flow-relation-card{position:relative;display:grid;grid-template-columns:minmax(82px,.8fr) minmax(104px,1.4fr) minmax(82px,.8fr);gap:0;align-items:center;padding:9px 8px 7px;border:1px solid var(--border);border-radius:10px;background:color-mix(in srgb,var(--surface-2) 72%,var(--surface))}.mv-flow-relation-card[data-flow-relation-role=cycle]{border-color:color-mix(in srgb,var(--accent) 44%,var(--border));box-shadow:inset 3px 0 0 var(--accent)}.mv-flow-relation-card[data-flow-relation-role=cycle]::before{content:'闭环回边';position:absolute;z-index:3;top:-7px;left:9px;padding:2px 5px;border-radius:999px;background:var(--accent-soft);color:var(--accent-strong);font:650 7.5px/1 var(--mono)}.mv-flow-endpoint{position:relative;z-index:2;min-width:0;padding:6px 8px;border:1px dashed var(--border);border-radius:999px;background:var(--surface);color:var(--text);font:650 9px/1.25 var(--mono);text-align:center;overflow-wrap:anywhere}.mv-flow-relation-card>.mv-connector--auxiliary{width:100%;min-width:0;max-width:none;min-height:44px;flex:none;align-content:start}.mv-flow-relation-card>.mv-connector--auxiliary>span{position:relative;display:block;width:100%;height:14px;margin-top:4px;font-size:0}.mv-flow-relation-card>.mv-connector--auxiliary>span::before{content:'';position:absolute;left:0;right:0;top:6px;height:2px;background:var(--accent)}.mv-flow-relation-card>.mv-connector--auxiliary>span::after{content:'';position:absolute;right:1px;top:2px;width:7px;height:7px;border-top:2px solid var(--accent);border-right:2px solid var(--accent);transform:rotate(45deg)}.mv-flow-relation-card>.mv-connector--auxiliary[data-visual-direction=reverse]>span::after{right:auto;left:1px;transform:rotate(-135deg)}.mv-flow-relation-card>.mv-connector--auxiliary>small{max-width:100%;margin-top:2px}.mv-flow-relation-card>.mv-connector--auxiliary>.mv-fact{max-width:100%;margin-top:3px}
...
.mv-argument{display:grid;grid-template-columns:minmax(220px,34%) minmax(0,1fr);gap:14px;align-items:center}.mv-argument-claim{grid-column:1}.mv-argument-evidence-list{grid-column:2;display:grid;gap:8px}.mv-argument-evidence{display:grid;grid-template-columns:minmax(128px,22%) minmax(0,1fr);align-items:center;gap:7px}.mv-argument-evidence-main,.mv-argument-links,.mv-argument-link{display:grid;gap:5px;min-width:0}.mv-argument-link{justify-items:center}.mv-argument-connector{position:relative;display:grid;place-items:center;width:calc(100% + 21px);min-height:28px;margin-left:-14px;margin-right:-7px}.mv-argument-connector::before{content:'';position:absolute;z-index:0;left:0;right:0;top:50%;height:2px;background:color-mix(in srgb,var(--good) 58%,var(--border));transform:translateY(-50%)}.mv-argument-connector::after{content:'';position:absolute;z-index:1;top:50%;width:8px;height:8px;border-top:2px solid var(--good);border-right:2px solid var(--good)}.mv-argument-connector[data-direction=to-claim]::after{left:1px;transform:translateY(-50%) rotate(-135deg)}.mv-argument-connector[data-direction=from-claim]::after{right:1px;transform:translateY(-50%) rotate(45deg)}.mv-argument-relation{position:relative;z-index:2;padding:4px 7px;border:1px solid color-mix(in srgb,var(--good) 34%,var(--border));border-radius:999px;background:var(--good-soft);color:var(--good);font:650 8.5px/1.2 var(--mono)}.mv-argument-link>.mv-fact{max-width:150px}
...
@container(max-width:650px){.mv-view-header{grid-template-columns:1fr}.mv-view-header>*{grid-column:1}.mv-region--container[data-axis=horizontal],.mv-diagram>.mv-region--container[data-axis=horizontal]{grid-template-columns:minmax(0,1fr)}.mv-region--band{grid-template-columns:minmax(108px,28%) minmax(0,1fr)}.mv-flow-sequence{display:grid;min-width:0;overflow:visible}.mv-flow-step{min-width:0}.mv-connector{min-height:42px;flex:none}.mv-connector>span{transform:rotate(90deg)}.mv-flow-branch,.mv-flow-branch--unlinked{grid-template-columns:1fr}.mv-flow-branch-ref{justify-self:stretch}.mv-argument{grid-template-columns:1fr}.mv-argument-claim,.mv-argument-evidence-list{grid-column:1}.mv-argument-evidence{grid-template-columns:1fr}.mv-argument-link{justify-items:center}.mv-argument-connector{width:100%;min-height:38px;margin:0}.mv-argument-connector::before{left:50%;right:auto;top:0;bottom:0;width:2px;height:auto;transform:translateX(-50%)}.mv-argument-connector[data-direction=to-claim]::after{left:50%;top:1px;transform:translateX(-50%) rotate(-45deg)}.mv-argument-connector[data-direction=from-claim]::after{left:50%;right:auto;top:auto;bottom:1px;transform:translateX(-50%) rotate(135deg)}}
"""
V3_JS = (
    SHELL_JS
